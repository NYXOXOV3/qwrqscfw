...
local function fishingLoop()
    while BlatantV2.Active do
        ...
        task.wait(BlatantV2.Settings.ReCastDelay)
    end
end
...
function BlatantV2.UpdateSettings(completeDelay, cancelDelay, reCastDelay)
    ...
    if reCastDelay ~= nil then
        BlatantV2.Settings.ReCastDelay = reCastDelay
    end
end
